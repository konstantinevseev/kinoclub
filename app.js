...
function init() {
    ...
    elements.themeToggle?.addEventListener('click', (e) => {
        e.stopPropagation();
        elements.themePopup?.classList.toggle('active');
    });
    ...
    document.querySelectorAll('.theme-popup-option').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            elements.themePopup?.classList.remove('active');
        });
    });
    
    // Close theme popup on outside click
    document.addEventListener('click', (e) => {
        if (elements.themePopup?.classList.contains('active') && 
            !elements.themePopup.contains(e.target) && 
            !elements.themeToggle?.contains(e.target)) {
            elements.themePopup.classList.remove('active');
        }
    });
